...
using CQRS.Application.Mappers;
using CQRS.Domain.Entities;
using CQRS.Domain.Entities.DTOs;
using Moq;

namespace CQRSTest.Services
{
    public class UserService
    {
        ...
        // Create User Test
        [Theory]
        [MemberData(nameof(GetUserFromDataGenerator), MemberType = typeof(UserService))]
        ...
        {
            if (inputUser.Name == user.Name && inputUser.Email == user.Email && inputUser.PasswordHash == user.PasswordHash
